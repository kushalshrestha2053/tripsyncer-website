...
import { footerData } from "./mobileFooterData";
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-6 mt-4 ml-4 md:mt-0">
              <Link
          ...
          <div>
            <h2
              className="dark:text-gray-300 font-semibold mb-4 flex justify-between items-center cursor-pointer"
          ...
          <div>
            ...
            <nav
              className={`flex flex-col space-y-3 ${isComparisonOpen ? "block" : "hidden"} md:flex md:space-y-4`}
            >
              {footerData.comparison.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-gray-600 dark:text-gray-300 hover:text-accent"
        ...
        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-center items-center mt-12 pt-8 border-t border-gray-800">
          <div className="flex items-center space-x-12">
            ...
            <Link
              href="/sitemap"
              className="text-gray-400 dark:text-gray-300 text-sm hover:text-accent"
            >
              Sitemap
            </Link>
          </div>
