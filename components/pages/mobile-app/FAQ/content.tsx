...
const faqs: FAQItem[] = [
  {
    question: "Can I use TripSyncer for both trips and events?",
    answer:
      "Yes! Switch between Road Trip and Event modes easily within the app.",
  },
  {
    question: "How do I share trip or event details with others?",
    answer:
      "Generate a shareable link for itineraries, directions, or RSVPs in just one click.",
  },
];
